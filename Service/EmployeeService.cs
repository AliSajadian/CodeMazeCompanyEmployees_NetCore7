...
{ 
    ...
    { 
        ...
        var employeeDb = await GetEmployeeAndCheckIfItExists(companyId, id, trackChanges); 
    ...
    { 
        ...
        var employeeForCompany = await GetEmployeeAndCheckIfItExists(companyId, id, trackChanges); 
    ...
    { 
            ...
            var employeeDb = await GetEmployeeAndCheckIfItExists(companyId, id, empTrackChanges); 
